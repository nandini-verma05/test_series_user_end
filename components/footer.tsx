        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center mb-4">
              <div className="text-white font-bold text-2xl">
                <span className="text-orange-400">Samagra</span>
                <span className="text-black">CS</span>
              </div>
            </div>
            <p className="text-gray-300 text-sm mb-4">
              Empowering students through knowledge and assessment solutions.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/tests" className="text-gray-300 hover:text-white text-sm">
                  All Tests
                </Link>
              </li>
              <li>
                <Link href="/results" className="text-gray-300 hover:text-white text-sm">
                  My Results
                </Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li className="flex items-center">
                ...
                <span>support@samgracs.com</span>
              </li>
              <li className="flex items-center">
                <svg className="h-5 w-5 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-700 pt-8 mt-8 md:flex md:items-center md:justify-between">
          <div className="flex space-x-6 md:order-2">
            <p className="text-gray-400 text-sm">
              © {currentYear} samagra cs. All rights reserved.
            </p>
          </div>
